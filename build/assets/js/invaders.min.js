...
this.options.complete.call(this.elem)}return!1}return e=b-this.startTime,this.state=e/this.options.duration,a=this.options.easing||(s.easing.swing?"swing":"linear"),this.pos=s.easing[this.options.specialEasing&&this.options.specialEasing[this.prop]||a](this.state,e,0,1,this.options.duration),this.now=this.start+(this.end-this.start)*this.pos,this.update(),!0}},s.extend(s.fx,{tick:function(){for(var a=s.timers,b=0;b<a.length;b++)a[b]()||a.splice(b--,1);a.length||s.fx.stop()},stop:function(){clearInterval(Pb),Pb=null},speeds:{slow:600,fast:200,_default:400},step:{opacity:function(a){s.style(a.elem,"opacity",a.now)},_default:function(a){a.elem.style&&null!=a.elem.style[a.prop]?a.elem.style[a.prop]=("width"===a.prop||"height"===a.prop?Math.max(0,a.now):a.now)+a.unit:a.elem[a.prop]=a.now}}}),s.expr&&s.expr.filters&&(s.expr.filters.animated=function(a){return s.grep(s.timers,function(b){return a===b.elem}).length}),s.fn.offset="getBoundingClientRect"in v.documentElement?function(a){var b=this[0];if(a)return this.each(function(b){s.offset.setOffset(this,a,b)});if(!b||!b.ownerDocument)return null;if(b===b.ownerDocument.body)return s.offset.bodyOffset(b);var c=b.getBoundingClientRect(),d=b.ownerDocument;return b=d.body,d=d.documentElement,{top:c.top+(self.pageYOffset||s.support.boxModel&&d.scrollTop||b.scrollTop)-(d.clientTop||b.clientTop||0),left:c.left+(self.pageXOffset||s.support.boxModel&&d.scrollLeft||b.scrollLeft)-(d.clientLeft||b.clientLeft||0)}}:function(a){var b=this[0];if(a)return this.each(function(b){s.offset.setOffset(this,a,b)});if(!b||!b.ownerDocument)return null;if(b===b.ownerDocument.body)return s.offset.bodyOffset(b);s.offset.initialize();var c,d=b.offsetParent,e=b,f=b.ownerDocument,g=f.documentElement,h=f.body;e=(f=f.defaultView)?f.getComputedStyle(b,null):b.currentStyle;for(var i=b.offsetTop,j=b.offsetLeft;(b=b.parentNode)&&b!==h&&b!==g&&(!s.offset.supportsFixedPosition||"fixed"!==e.position);)c=f?f.getComputedStyle(b,null):b.currentStyle,i-=b.scrollTop,j-=b.scrollLeft,b===d&&(i+=b.offsetTop,j+=b.offsetLeft,!s.offset.doesNotAddBorder||s.offset.doesAddBorderForTableAndCells&&/^t(able|d|h)$/i.test(b.nodeName)||(i+=parseFloat(c.borderTopWidth)||0,j+=parseFloat(c.borderLeftWidth)||0),e=d,d=b.offsetParent),s.offset.subtractsBorderForOverflowNotVisible&&"visible"!==c.overflow&&(i+=parseFloat(c.borderTopWidth)||0,j+=parseFloat(c.borderLeftWidth)||0),e=c;return("relative"===e.position||"static"===e.position)&&(i+=h.offsetTop,j+=h.offsetLeft),s.offset.supportsFixedPosition&&"fixed"===e.position&&(i+=Math.max(g.scrollTop,h.scrollTop),j+=Math.max(g.scrollLeft,h.scrollLeft)),{top:i,left:j}},s.offset={initialize:function(){var a,b,c,d=v.body,e=v.createElement("div"),f=parseFloat(s.curCSS(d,"marginTop",!0))||0;s.extend(e.style,{position:"absolute",top:0,left:0,margin:0,border:0,width:"1px",height:"1px",visibility:"hidden"}),e.innerHTML="<div style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;'><div></div></div><table style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>",d.insertBefore(e,d.firstChild),a=e.firstChild,b=a.firstChild,c=a.nextSibling.firstChild.firstChild,this.doesNotAddBorder=5!==b.offsetTop,this.doesAddBorderForTableAndCells=5===c.offsetTop,b.style.position="fixed",b.style.top="20px",this.supportsFixedPosition=20===b.offsetTop||15===b.offsetTop,b.style.position=b.style.top="",a.style.overflow="hidden",a.style.position="relative",this.subtractsBorderForOverflowNotVisible=-5===b.offsetTop,this.doesNotIncludeMarginInBodyOffset=d.offsetTop!==f,d.removeChild(e),s.offset.initialize=s.noop},bodyOffset:function(a){var b=a.offsetTop,c=a.offsetLeft;return s.offset.initialize(),s.offset.doesNotIncludeMarginInBodyOffset&&(b+=parseFloat(s.curCSS(a,"marginTop",!0))||0,c+=parseFloat(s.curCSS(a,"marginLeft",!0))||0),{top:b,left:c}},setOffset:function(a,b,c){/static/.test(s.curCSS(a,"position"))&&(a.style.position="relative");var d=s(a),e=d.offset(),f=parseInt(s.curCSS(a,"top",!0),10)||0,g=parseInt(s.curCSS(a,"left",!0),10)||0;s.isFunction(b)&&(b=b.call(a,c,e)),c={top:b.top-e.top+f,left:b.left-e.left+g},"using"in b?b.using.call(a,c):d.css(c)}},s.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=/^body|html$/i.test(b[0].nodeName)?{top:0,left:0}:b.offset();return c.top-=parseFloat(s.curCSS(a,"marginTop",!0))||0,c.left-=parseFloat(s.curCSS(a,"marginLeft",!0))||0,d.top+=parseFloat(s.curCSS(b[0],"borderTopWidth",!0))||0,d.left+=parseFloat(s.curCSS(b[0],"borderLeftWidth",!0))||0,{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||v.body;a&&!/^body|html$/i.test(a.nodeName)&&"static"===s.css(a,"position");)a=a.offsetParent;return a})}}),s.each(["Left","Top"],function(a,c){var d="scroll"+c;s.fn[d]=function(c){var e,f=this[0];return f?c!==b?this.each(function(){(e=p(this))?e.scrollTo(a?s(e).scrollLeft():c,a?c:s(e).scrollTop()):this[d]=c}):(e=p(f))?"pageXOffset"in e?e[a?"pageYOffset":"pageXOffset"]:s.support.boxModel&&e.document.documentElement[d]||e.document.body[d]:f[d]:null}}),s.each(["Height","Width"],function(a,c){var d=c.toLowerCase();s.fn["inner"+c]=function(){return this[0]?s.css(this[0],d,!1,"padding"):null},s.fn["outer"+c]=function(a){return this[0]?s.css(this[0],d,!1,a?"margin":"border"):null},s.fn[d]=function(a){var e=this[0];return e?s.isFunction(a)?this.each(function(b){var c=s(this);c[d](a.call(this,b,c[d]()))}):"scrollTo"in e&&e.document?"CSS1Compat"===e.document.compatMode&&e.document.documentElement["client"+c]||e.document.body["client"+c]:9===e.nodeType?Math.max(e.documentElement["client"+c],e.body["scroll"+c],e.documentElement["scroll"+c],e.body["offset"+c],e.documentElement["offset"+c]):a===b?s.css(e,d):this.css(d,"string"==typeof a?a:a+"px"):null==a?null:this}}),a.jQuery=a.$=s}(window),window.Modernizr=function(a,b,c){function d(a){n.cssText=a}function e(a,b){return typeof a===b}var f,g,h,i="2.5.3",j={},k=b.documentElement,l="modernizr",m=b.createElement(l),n=m.style,o=({}.toString," -webkit- -moz- -o- -ms- ".split(" ")),p={},q=[],r=q.slice,s=function(a,c,d,e){var f,g,h,i=b.createElement("div"),j=b.body,m=j?j:b.createElement("body");if(parseInt(d,10))for(;d--;)h=b.createElement("div"),h.id=e?e[d]:l+(d+1),i.appendChild(h);return f=["&#173;","<style>",a,"</style>"].join(""),i.id=l,(j?i:m).innerHTML+=f,m.appendChild(i),j||(m.style.background="",k.appendChild(m)),g=c(i,a),j?i.parentNode.removeChild(i):m.parentNode.removeChild(m),!!g},t={}.hasOwnProperty;h=e(t,"undefined")||e(t.call,"undefined")?function(a,b){return b in a&&e(a.constructor.prototype[b],"undefined")}:function(a,b){return t.call(a,b)},Function.prototype.bind||(Function.prototype.bind=function(a){var b=this;if("function"!=typeof b)throw new TypeError;var c=r.call(arguments,1),d=function(){if(this instanceof d){var e=function(){};e.prototype=b.prototype;var f=new e,g=b.apply(f,c.concat(r.call(arguments)));return Object(g)===g?g:f}return b.apply(a,c.concat(r.call(arguments)))};return d}),function(c,d){var e=c.join(""),f=d.length;s(e,function(c){for(var d=b.styleSheets[b.styleSheets.length-1],e=(d?d.cssRules&&d.cssRules[0]?d.cssRules[0].cssText:d.cssText||"":"",c.childNodes),g={};f--;)g[e[f].id]=e[f];j.touch="ontouchstart"in a||a.DocumentTouch&&b instanceof DocumentTouch||9===(g.touch&&g.touch.offsetTop)},f,d)}([,["@media (",o.join("touch-enabled),("),l,")","{#touch{top:9px;position:absolute}}"].join("")],[,"touch"]),p.touch=function(){return j.touch};for(var u in p)h(p,u)&&(g=u.toLowerCase(),j[g]=p[u](),q.push((j[g]?"":"no-")+g));return d(""),m=f=null,j._version=i,j._prefixes=o,j.testStyles=s,j}(this,this.document),function(a){function b(a,b,c){this.screenX=c.screenX||0,this.screenY=c.screenY||0,this.pageX=c.pageX||0,this.pageY=c.pageY||0,this.clientX=c.clientX||0,this.clientY=c.clientY||0,this.tiltX=c.tiltX||0,this.tiltY=c.tiltY||0,this.pressure=c.pressure||0,this.hwTimestamp=c.hwTimestamp||0,this.pointerType=b,this.identifier=a}function c(a){a.target.mouseEvent=a}function d(a){a.target.mouseEvent=null}function e(a){a.target.touchList=a.targetTouches}function f(){var a=[];if(this.touchList)for(var c=0;c<this.touchList.length;c++){var d=this.touchList[c],e=new b(d.identifier+2,y.TOUCH,d);a.push(e)}else if(this.msPointerList)for(var f in this.msPointerList)if(this.msPointerList.hasOwnProperty(f)){var e=this.msPointerList[f],e=new b(f,e.textPointerType,e);a.push(e)}return this.mouseEvent&&a.push(new b(x,y.MOUSE,this.mouseEvent)),a}function g(a,b,c){var d=document.createEvent("Event");d.initEvent(a,!0,!0);for(var e in c)d[e]=c[e];b.dispatchEvent(d)}function h(a){a.preventDefault(),c(a);var b={pointerType:"mouse",getPointerList:f.bind(this),originalEvent:a};g("pointerdown",a.target,b)}function i(a){a.preventDefault(),a.target.mouseEvent&&c(a);var b={pointerType:"mouse",getPointerList:f.bind(this),originalEvent:a};g("pointermove",a.target,b)}function j(a){a.preventDefault(),d(a);var b={pointerType:"mouse",getPointerList:f.bind(this),originalEvent:a};g("pointerup",a.target,b)}function k(a){console.log("touchstart"),a.preventDefault(),e(a);var b={pointerType:"touch",getPointerList:f.bind(this),originalEvent:a};g("pointerdown",a.target,b)}function l(a){a.preventDefault(),e(a);var b={pointerType:"touch",getPointerList:f.bind(this),originalEvent:a};g("pointermove",a.target,b)}function m(a){a.preventDefault(),e(a);var b={pointerType:"touch",getPointerList:f.bind(this),originalEvent:a};g("pointerup",a.target,b)}function n(a){if(a.target.mouseEvent){console.log(a),a.preventDefault(),d(a);var b={pointerType:"mouse",getPointerList:f.bind(this),originalEvent:a};g("pointerup",a.target,b)}}function o(a){2==a.pointerType?a.textPointerType=y.TOUCH:3==a.pointerType?a.textPointerType=y.PEN:4==a.pointerType&&(a.textPointerType=y.MOUSE),a.textPointerType==y.MOUSE&&(a.target.msMouseDown=!0),a.target.msPointerList||(a.target.msPointerList={}),a.target.msPointerList[a.pointerId]=a;var b={pointerType:a.textPointerType,getPointerList:f.bind(this),originalEvent:a};g("pointerdown",a.target,b)}function p(a){if(2==a.pointerType?a.textPointerType=y.TOUCH:3==a.pointerType?a.textPointerType=y.PEN:4==a.pointerType&&(a.textPointerType=y.MOUSE),a.textPointerType!=y.MOUSE||a.target.msMouseDown){a.target.msPointerList||(a.target.msPointerList={}),a.target.msPointerList[a.pointerId]=a;var b={pointerType:a.textPointerType,getPointerList:f.bind(this),originalEvent:a};g("pointermove",a.target,b)}}function q(a){a.target.msPointerList&&delete a.target.msPointerList[a.pointerId],2==a.pointerType?a.textPointerType=y.TOUCH:3==a.pointerType?a.textPointerType=y.PEN:4==a.pointerType&&(a.textPointerType=y.MOUSE),a.textPointerType==y.MOUSE&&(a.target.msMouseDown=!1);var b={pointerType:a.textPointerType,getPointerList:f.bind(this),originalEvent:a};g("pointerup",a.target,b)}function r(a){a.isPointerEmitter||(u()?(a.addEventListener("pointerdown",o),a.addEventListener("pointermove",p),a.addEventListener("pointerup",q)):t()?(a.addEventListener("MSPointerDown",o),a.addEventListener("MSPointerMove",p),a.addEventListener("MSPointerUp",q)):(s()&&(a.addEventListener("touchstart",k),a.addEventListener("touchmove",l),a.addEventListener("touchend",m)),a.addEventListener("mousedown",h),a.addEventListener("mousemove",i),a.addEventListener("mouseup",j),a.addEventListener("mouseout",n)),a.isPointerEmitter=!0)}function s(){return Modernizr.touch}function t(){return window.navigator.msPointerEnabled}function u(){return window.navigator.pointerEnabled}function v(a,b){var c=a.prototype.addEventListener;a.prototype.addEventListener=function(a,d,e){b.call(this,a,d,e),c.call(this,a,d,e)}}function w(a){0===a.indexOf("pointer")&&r(this)}var x=1,y={TOUCH:"touch",MOUSE:"mouse",PEN:"pen"};navigator.userAgent.match(/Firefox/)?(v(HTMLDivElement,w),v(HTMLCanvasElement,w)):v(HTMLElement,w),a._createCustomEvent=g,a._augmentAddEventListener=v,a.PointerTypes=y}(window),function(a){function b(a){if(0===a.indexOf("gesture")){var b=Gesture._gestureHandlers[a];b?b(this):console.error("Warning: no handler found for {{evt}}.".replace("{{evt}}",a))}}navigator.userAgent.match(/Firefox/)?(window._augmentAddEventListener(HTMLDivElement,b),window._augmentAddEventListener(HTMLCanvasElement,b)):window._augmentAddEventListener(HTMLElement,b),a.Gesture=a.Gesture||{},a.Gesture._gestureHandlers=a.Gesture._gestureHandlers||{}}(window),function(a){function b(a){this.x=a.clientX,this.y=a.clientY}function c(a){var c=a.getPointerList();if(1==c.length){var d=new Date;if(d-this.lastDownTime<e&&this.lastPosition&&this.lastPosition.calculateSquaredDistance(c[0])<f*f){this.lastDownTime=0,this.lastPosition=null;var g={};window._createCustomEvent("gesturedoubletap",a.target,g)}this.lastPosition=new b(c[0]),this.lastDownTime=d}}function d(a){a.addEventListener("pointerdown",c)}var e=300,f=10;b.prototype.calculateSquaredDistance=function(a){var b=this.x-a.clientX,c=this.y-a.clientY;return b*b+c*c},a.Gesture._gestureHandlers.gesturedoubletap=d}(window),function(a){function b(a){this.x=a.clientX,this.y=a.clientY}function c(a){clearTimeout(this.longPressTimer);var c=a.getPointerList();1===c.length&&(a.target.longpressInitPosition=new b(c[0]),this.longPressTimer=setTimeout(function(){payload={},window._createCustomEvent("gesturelongpress",a.target,payload)},g))}function d(a){var b=a.getPointerList();if(a.pointerType===PointerTypes.MOUSE)clearTimeout(this.longPressTimer);else if(1===b.length){var c=a.target.longpressInitPosition;c&&c.calculateSquaredDistance(b[0])>h*h&&clearTimeout(this.longPressTimer)}}function e(){clearTimeout(this.longPressTimer)}function f(a){a.addEventListener("pointerdown",c),a.addEventListener("pointermove",d),a.addEventListener("pointerup",e)}var g=600,h=5;b.prototype.calculateSquaredDistance=function(a){var b=this.x-a.clientX,c=this.y-a.clientY;return b*b+c*c},a.Gesture._gestureHandlers.gesturelongpress=f}(window),function(a){function b(a,b){this.p1=a,this.p2=b}function c(a){var c=a.getPointerList();2==c.length&&(a.target.scaleReferencePair=new b(c[0],c[1]))}function d(a){var c=a.getPointerList();if(2==c.length&&a.target.scaleReferencePair){var d=new b(c[0],c[1]),e=d.scaleSince(a.target.scaleReferencePair);if(Math.abs(1-e)>g){var f={scale:e,centerX:(a.target.scaleReferencePair.p1.clientX+a.target.scaleReferencePair.p2.clientX)/2,centerY:(a.target.scaleReferencePair.p1.clientY+a.target.scaleReferencePair.p2.clientY)/2};window._createCustomEvent("gesturescale",a.target,f)}}}function e(a){a.target.scaleReferencePair=null}function f(a){a.addEventListener("pointerdown",c),a.addEventListener("pointermove",d),a.addEventListener("pointerup",e)}var g=.2;b.prototype.center=function(){return[(this.p1.pageX+this.p2.pageX)/2,(this.p1.pageY+this.p2.pageY)/2]},b.prototype.span=function(){var a=this.p1.pageX-this.p2.pageX,b=this.p1.pageY-this.p2.pageY;return Math.sqrt(a*a+b*b)},b.prototype.scaleSince=function(a){var b=this.span(),c=a.span();return 0==c?0:b/c},a.Gesture._gestureHandlers.gesturescale=f}(window);var Stats=function(){var a=Date.now(),b=a,c=0,d=1/0,e=0,f=0,g=1/0,h=0,i=0,j=0,k=document.createElement("div");k.id="stats",k.addEventListener("mousedown",function(a){a.preventDefault(),s(++j%2)},!1),k.style.cssText="width:80px;opacity:0.9;cursor:pointer";var l=document.createElement("div");l.id="fps",l.style.cssText="padding:0 0 3px 3px;text-align:left;background-color:#002",k.appendChild(l);var m=document.createElement("div");m.id="fpsText",m.style.cssText="color:#0ff;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px",m.innerHTML="FPS",l.appendChild(m);var n=document.createElement("div");for(n.id="fpsGraph",n.style.cssText="position:relative;width:74px;height:30px;background-color:#0ff",l.appendChild(n);74>n.children.length;){var o=document.createElement("span");o.style.cssText="width:1px;height:30px;float:left;background-color:#113",n.appendChild(o)}var p=document.createElement("div");p.id="ms",p.style.cssText="padding:0 0 3px 3px;text-align:left;background-color:#020;display:none",k.appendChild(p);var q=document.createElement("div");q.id="msText",q.style.cssText="color:#0f0;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px",q.innerHTML="MS",p.appendChild(q);var r=document.createElement("div");for(r.id="msGraph",r.style.cssText="position:relative;width:74px;height:30px;background-color:#0f0",p.appendChild(r);74>r.children.length;)o=document.createElement("span"),o.style.cssText="width:1px;height:30px;float:left;background-color:#131",r.appendChild(o);var s=function(a){switch(j=a){case 0:l.style.display="block",p.style.display="none";break;case 1:l.style.display="none",p.style.display="block"}};return{REVISION:11,domElement:k,setMode:s,begin:function(){a=Date.now()},end:function(){var j=Date.now();c=j-a,d=Math.min(d,c),e=Math.max(e,c),q.textContent=c+" MS ("+d+"-"+e+")";var k=Math.min(30,30-30*(c/200));return r.appendChild(r.firstChild).style.height=k+"px",i++,j>b+1e3&&(f=Math.round(1e3*i/(j-b)),g=Math.min(g,f),h=Math.max(h,f),m.textContent=f+" FPS ("+g+"-"+h+")",k=Math.min(30,30-30*(f/100)),n.appendChild(n.firstChild).style.height=k+"px",b=j,i=0),j},update:function(){a=this.end()}}};window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(a){window.setTimeout(a,1e3/60)}}();var Game={};Game.Item=function(){this.x=0,this.y=0,this.width=50,this.height=30,this.spriteCanvas=null,this.spritex=0,this.spritey=0,this.speedy=12,this.initialSpeedy=10,this.speedx=12,this.initialSpeedx=10,this.type="",this.color="#ff0099",this.slowmode=!1,this.spriteCanvas=null},Game.Item.prototype.update=function(a,b){this.x=a,this.y=b},Game.Item.prototype.updatey=function(a){this.y=a},Game.Item.prototype.updatex=function(a){this.x=a},Game.Item.prototype.render=function(a){this.spriteCanvas?a.drawImage(this.spriteCanvas,this.spritex,this.spritey,this.width,this.height,this.x,this.y,this.width,this.height):(a.fillStyle=this.color,a.fillRect(this.x,this.y,this.width,this.height))},Game.Item.prototype.createShape=function(a,b,c){this.spriteCanvas=a,this.spritex=b,this.spritey=c,this.spriteCanvas.getContext("2d")},Game.GroupItem=function(){this.items=[],this.slowmode=!1,this.stageWidth=0,this.stageHeight=0},Game.GroupItem.prototype.update=function(a){a/=10;for(var b=this.items.length,c=0;b>c;c++){var d=this.items[c];if(d){this.slowmode===!0?(d.speedx=.5*d.initialSpeedx,d.speedy=.5*d.initialSpeedy):(d.speedx=d.initialSpeedx,d.speedy=d.initialSpeedy);var e=d.x+d.speedx*a,f=d.y+d.speedy*a,g=200;e>this.stageWidth+g||e<0-d.width-g||f>this.stageHeight+g||0-g>e?this.kill(d):d.update(e,f)}}},Game.GroupItem.prototype.updateStage=function(a,b){this.stageWidth=a,this.stageHeight=b},Game.GroupItem.prototype.render=function(a){for(var b=this.items.length,c=0;b>c;c++)this.items[c].render(a)},Game.GroupItem.prototype.slowDown=function(){this.slowmode=!0},Game.GroupItem.prototype.resetSpeed=function(){this.slowmode=!1},Game.GroupItem.prototype.getItems=function(){return this.items},Game.GroupItem.prototype.kill=function(a){for(var b=this.items.length,c=0;b>c;c++)this.items[c]===a&&this.items.splice(c,1)},Game.Collision=function(a,b){var c=a,d=b,e=4,f=8,g=0,h=0,i=[];this.createGrid=function(){g=c/f,h=d/e;for(var a=0;e>a;a++)for(var b=0;f>b;b++)j(b*g,a*h)},this.addObjects=function(a){for(var b=0;b<i.length;b++)i[b].objects=[];for(var c=0;c<i.length;c++)for(var d=0;d<a.length;d++)if(a[d].x>i[c].x&&a[d].x<i[c].x+i[c].width&&a[d].y>i[c].y&&a[d].y<i[c].y+i[c].height){var e=a[d];i[c].objects.push(e);var g=i[c+1],h=i[c+f],j=i[c+(f+1)],k=!1,l=!1;e.x+e.width>i[c].x+i[c].width&&(g&&g.objects.push(e),k=!0),e.y+e.height>i[c].y+i[c].height&&(h&&h.objects.push(e),l=!0),l===!0&&k===!0&&j&&j.objects.push(e)}},this.detect=function(){for(var a=[],b=0;b<i.length;b++){var c=i[b].objects;if(!(c.length<2))for(var d=0;d<c.length;d++)for(var e=0;e<c.length;e++)d!==e&&(c[d].x>c[e].x+c[e].width||c[d].x+c[d].width<c[e].x||c[d].y>c[e].y+c[e].height||c[d].y+c[d].height<c[e].y||c[d].type!==c[e].type&&a.push({object1:c[d],object2:c[e]}))}return a},this.drawGrid=function(a){for(var b=0;b<i.length;b++)k(i[b],a)};var j=function(a,b){i.push({x:a,y:b,width:c/f,height:d/e,objects:[]})},k=function(a,b){b.beginPath(),b.rect(a.x,a.y,a.width,a.height),b.lineWidth=1,b.strokeStyle="white",b.stroke();var c=a.objects.length;b.lineWidth=1,b.fillStyle=1>c?"#666":"#00ff00",b.font="14px sans-serif",b.fillText("Objects: "+c,a.x,a.y+20)}},Game.Engine=function(){var a,b,c,d,e,f,g,h,j,k,l,m,n,o,p,q,r,s=!1,t=!1,u=!1,v=[];this.init=function(){console.log("init..."),r=new Stats,r.domElement.style.position="absolute",r.domElement.style.top="0px",document.getElementById("body").appendChild(r.domElement),h=$(window).width()-2,j=$(window).height()-2,k=document.getElementById("scene"),k.width=h,k.height=j,l=k.getContext("2d"),g=new Game.Sprite,g.init(),m=(new Date).getTime(),b=new Game.Bullets,d=new Game.Particles,c=new Game.Enemies,c.spriteCanvas=g.getCanvas(),e=new Game.Prizes,f=new Game.Collision(h,j),f.createGrid(),a=new Game.Player,a.spriteCanvas=g.getCanvas(),a.color="#0000ff",a.type="player",a.update(k.width/2-a.width/2,k.height-a.height),g.addShapeToSprite(a),w(),H(),x()};var w=function(){b.updateStage(h,j),d.updateStage(h,j),c.updateStage(h,j),e.updateStage(h,j)},x=function(){r.begin(),requestAnimFrame(x),s||(n=(new Date).getTime(),o=n-m,m=n,z(),y(),l.clearRect(0,0,k.width,k.height),E(n),b.update(o),c.update(o),d.update(o),e.update(o),B(),A(),r.end())},y=function(){q=e.lastSpawn+1e3/e.spawningSpeed<n,q&&(e.addPrize(),e.lastSpawn=n)},z=function(){if(p=c.lastSpawn+1e3/c.spawningSpeed<n){var a=c.addEnemy(g);g.addShapeToSprite(a),c.lastSpawn=n}},A=function(){b.render(l),c.render(l),d.render(l),a.render(l),e.render(l),u?(f.drawGrid(l),g.showDebug()):g.hideDebug()},B=function(){var a=D();f.addObjects(a);var g=f.detect(),h=g.length;for(i=0;h>i;i++){if("bullet"==g[i].object1.type&&"enemy"==g[i].object2.type&&(d.add(g[i].object2),c.kill(g[i].object2),b.kill(g[i].object1)),"player"==g[i].object1.type&&"prize"==g[i].object2.type||"bullet"==g[i].object1.type&&"prize"==g[i].object2.type){var j=g[i].object2.prizes[g[i].object2.prize];C(j),d.add(g[i].object2),e.kill(g[i].object2)}"player"==g[i].object1.type&&"enemy"==g[i].object2.type&&log("game over")}},C=function(a){var b="<h1 class='splash'>"+a+"</h1>";$("body").append(b);var c=$(window).height()/2-$(".splash").height();switch($(".splash").css({top:c+"px"}),$(".splash").animate({opacity:0},3e3,function(){$(".splash").remove()}),a){case"speedammo":break;case"slowmotion":break;case"ammox3":break;case"ammox5":break;case"shield":}},D=function(){var d=c.getItems(),f=b.getItems(),g=e.getItems(),h=[],i=0,j=d.length;for(i=0;j>i;i++)h.push(d[i]);for(j=f.length,i=0;j>i;i++)h.push(f[i]);for(j=g.length,i=0;j>i;i++)h.push(g[i]);return h.push(a),h},E=function(c){var d=a.lastShot+1e3/a.shootingSpeed<c;(v[32]||a.autoshoot===!0)&&d&&(b.shoot(a),a.lastShot=c),v[37]&&a.updatex(a.x-a.speedx),v[38]&&a.updatey(a.y-a.speedy),v[39]&&a.updatex(a.x+a.speedx),v[40]&&a.updatey(a.y+a.speedy)},F=function(){b.slowDown(),c.slowDown(),d.slowDown(),e.slowDown()},G=function(){b.resetSpeed(),c.resetSpeed(),d.resetSpeed(),e.resetSpeed()},H=function(){$(document).keydown(function(a){J(a.keyCode)}),$(document).keyup(function(a){K(a.keyCode)}),k.addEventListener("pointerdown",I,!1),k.addEventListener("pointermove",I,!1)},I=function(b){var c=b.getPointerList(),d=c[0];d&&a.update(d.clientX-a.width/2,d.clientY-a.height)},J=function(b){v[b]=1,65===b&&a.toggleAutoShoot(),69===b&&a.toggleShootingSpeed(),81===b&&L(),86===b&&M(),83===b&&N()},K=function(a){v[a]=null},L=function(){s=s===!0?!1:!0},M=function(){u=u===!0?!1:!0},N=function(){t===!0?(t=!1,G()):(t=!0,F())}},Game.Bullets=function(){this.shoot=function(a){var b=new Game.Bullet;b.x=a.x+a.width/2,b.y=a.y,this.items.push(b)}},Game.Bullets.prototype=new Game.GroupItem,Game.Bullet=function(){this.width=2,this.height=6,this.type="bullet",this.speedy=-6,this.initialSpeedy=this.speedy,this.speedx=0,this.initialSpeedx=this.speedx},Game.Bullet.prototype=new Game.Item,Game.Enemies=function(){var a=this;this.lastSpawn=0,this.spawningSpeed=1,this.spawned=0;var b=10;this.addEnemy=function(c){var d=new Game.Enemy;if(d.x=Math.random()*this.stageWidth,d.y=0-d.height,a.items.push(d),this.spawned++,this.spawned>b){var e=c.getSpriteOfType("enemy");d.spritex=e.x,d.spritey=e.y,d.spriteCanvas=c.getCanvas()}return d}},Game.Enemies.prototype=new Game.GroupItem,Game.Enemy=function(){this.width=30,this.height=30,this.type="enemy",this.color="#ff0000",this.speedx=2*Math.random(),this.initialSpeedx=this.speedx,this.speedy=2*Math.random(),this.initialSpeedy=this.speedy,this.shape=[],this.size=0},Game.Enemy.prototype=new Game.Item,Game.Enemy.prototype.createShape=function(a,b,c){if(0!==this.spritex||0!==this.spritey)return!1;var d=5,e=5,f=[],g=0,h=0;this.spriteCanvas=a,this.spritex=b,this.spritey=c;var i=this.spriteCanvas.getContext("2d");for(this.size=this.width/e-1,g=0;d>g;g++)for(f[g]=[],h=0;h<Math.ceil(e/2);h++){var j=!1;Math.random()>.5&&(j=!0),f[g][h]={x:this.size*h,y:this.size*g,draw:j}}for(g=0;g<f.length;g++)for(h=0;h<f[g].length;h++){var k=e-h;f[g][k]={x:k*this.size,y:f[g][h].y,draw:f[g][h].draw}}for(g=0;g<f.length;g++)for(h=0;h<f[g].length;h++)this.shape.push(f[g][h]);for(i.fillStyle=this.color,g=0;g<this.shape.length;g++)this.shape[g].draw&&i.fillRect(this.spritex+this.shape[g].x,this.spritey+this.shape[g].y,this.size,this.size)},Game.Particles=function(){var a=20;this.add=function(b){for(var c=0;a>c;c++){var d=new Game.Particle;d.x=b.x+Math.random()*b.width,d.y=b.y+Math.random()*b.height,d.color=b.color,d.initialSpeedx=d.speedx,d.initialSpeedy=d.speedy,this.items.push(d)}},this.update=function(){for(var a=[],b=0;b<this.items.length;b++){var c=this.items[b];c.update(c.x+c.speedx,c.y+c.speedy),c.lived++,c.lived>c.lifespan&&a.push(b)}for(var d=0;d<a.length;d++)this.items.splice(a[d],1)}},Game.Particles.prototype=new Game.GroupItem,Game.Particle=function(){this.moveSpeed=4,this.lifespan=40,this.lived=0,this.width=2*Math.random(),this.height=this.width,this.lived=0,this.lifespan=140*Math.random(),this.speedx=Math.random()*this.moveSpeed-this.moveSpeed/2,this.speedy=Math.random()*this.moveSpeed-this.moveSpeed/2},Game.Particle.prototype=new Game.Item,Game.Player=function(){this.lastShot=0,this.shootingSpeed=5,this.autoshoot=!1,this.prizes=[],this.toggleAutoShoot=function(){this.autoshoot=this.autoshoot===!0?!1:!0},this.toggleShootingSpeed=function(){this.shootingSpeed=5===this.shootingSpeed?30:5},this.increaseShootingSpeed=function(){this.shootingSpeed=2*this.shootingSpeed},this.createShape=function(a,b,c){this.spriteCanvas=a,this.spritex=b,this.spritey=c;var d=this.spriteCanvas.getContext("2d");d.fillStyle=this.color,d.beginPath(),d.moveTo(this.spritex+this.width/2,this.spritey),d.lineTo(this.spritex+this.width,this.spritey+this.height),d.lineTo(this.spritex,this.spritey+this.height),d.lineTo(this.spritex+this.width/2,this.spritey),d.fill()}},Game.Player.prototype=new Game.Item,Game.Prizes=function(){var a=this;this.lastSpawn=0,this.spawningSpeed=.1,this.addPrize=function(){var b=new Game.Prize;b.width=20,b.height=20,b.type="prize",b.color="#00ff00",b.x=Math.random()*this.stageWidth,b.y=0-b.height,b.prize=Math.floor(Math.random()*b.prizes.length),b.speedx=0,b.initialSpeedx=b.speedx,b.speedy=.28,b.initialSpeedy=b.speedy,a.items.push(b)}},Game.Prizes.prototype=new Game.GroupItem,Game.Prize=function(){this.prizes=["slowmotion","speedammo","ammox3","ammox5","shield"],this.prize=null,this.length=5,this.size=0,this.pulsePos=0,this.pulseDuration=50},Game.Prize.prototype=new Game.Item,Game.Prize.prototype.pulse=function(a){var b=this.width/2+this.pulsePos/2;a.beginPath(),a.arc(this.x+this.size,this.y+this.size,b,0,2*Math.PI,!1),a.lineWidth=2,a.strokeStyle=this.color,a.save();var c=1-this.pulsePos/this.pulseDuration;a.globalAlpha=c,a.stroke(),a.restore(),this.pulsePos++,this.pulsePos>=this.pulseDuration&&(this.pulsePos=0)},Game.Prize.prototype.render=function(a){this.size=this.width/2,a.beginPath(),a.arc(this.x+this.size,this.y+this.size,this.size,0,2*Math.PI,!1),a.fillStyle=this.color,a.fill(),this.pulse(a)},Game.Sprite=function(){var a=null,b=null,c=0,d=0,e=0,f=!1,g=[];this.init=function(){a=document.createElement("canvas"),a.id="sprite_canvas",a.width=500,a.height=350,b=a.getContext("2d")},this.getCanvas=function(){return a},this.getSpriteOfType=function(a){for(var b,c,d="";d!=a;)c=Math.ceil(Math.random()*(g.length-1)),b=g[c],d=b.type;return b},this.addShapeToSprite=function(b){var f=b.createShape(a,c,d);f!==!1&&(g.push({x:c,y:d,width:b.width,height:b.height,type:b.type}),c+=b.width,b.height>e&&(e=b.height),c+b.width>a.width&&(d+=e,c=0,e=0))},this.showDebug=function(){document.getElementById("body").appendChild(a),f=!0},this.hideDebug=function(){f!==!1&&(document.getElementById("body").removeChild(a),f=!1)}},$(document).ready(function(){var a=new Game.Engine;a.init()});